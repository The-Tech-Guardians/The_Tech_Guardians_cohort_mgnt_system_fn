...
import { Menu, X, Users, BookOpen, Award, Target, Code, Briefcase, Heart, Calendar, ChevronRight, Sparkles, Clock, Star, CreditCard, Lock, CheckCircle } from "lucide-react";
...
export default function Home() {
  ...
  const courses = [
    { id: 1, name: "Social Media Branding", icon: Target, color: "bg-blue-50 text-blue-600", slug: "social-media",
    ...
    { id: 2, name: "Computer Programming", icon: Code, color: "bg-blue-50 text-blue-600", slug: "programming",
    ...
    { id: 3, name: "Entrepreneurship", icon: Briefcase, color: "bg-blue-50 text-blue-600", slug: "entrepreneurship",
    ...
    { id: 4, name: "SRHR", icon: Heart, color: "bg-blue-50 text-blue-600", slug: "srhr",
    ...
    { id: 5, name: "Team Management", icon: Award, color: "bg-blue-50 text-blue-600", slug: "team-management",
  ...
  const AboutContent = () => (
    <div className="space-y-5">
      <p className="text-gray-700">SafED is a structured cohort-based learning platform for real-world impact across Africa.</p>
    ...
    <div className="space-y-5">
      ...
      <div className="space-y-3">
        <div>
          ...
          <p className="text-gray-900">support@safed.com</p>
        </div>
        <div>
  ...
  const Modals = {
    ...
    about: { title: "About SafED", content: <AboutContent /> },
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto flex items-center justify-between py-4 px-6 max-w-7xl">
          <Link href="/" className="flex items-center gap-3">
            <div className="flex flex-col">
              <h1 className="text-2xl md:text-3xl font-bold tracking-tight">
                <span className="text-blue-600">Saf</span>
          ...
          <div className="hidden lg:flex items-center space-x-8">
            <button 
              onClick={() => setActiveModal('lightning')} 
          ...
          <button className="lg:hidden text-gray-700 p-2 rounded-lg" onClick={() => setMobileNavOpen(!mobileNavOpen)}>
        ...
        {mobileNavOpen && (
          <div className="lg:hidden bg-white border-t border-gray-200 shadow-lg">
            <div className="container mx-auto px-6 py-4">
              <button 
                onClick={() => { setActiveModal('lightning'); setMobileNavOpen(false); }} 
                className="block w-full text-left text-gray-700 py-3 border-b border-gray-100 hover:text-blue-600"
              >
                Lightning Lessons
              </button>
              <Link 
                href="/login" 
                className="block w-full bg-blue-600 text-white px-4 py-3 rounded-lg text-center mt-4 font-medium"
      ...
      <main className="flex-1">
        {/* Hero Section - EXACTLY LIKE MOODLE with YOUR IMAGE */}
            ...
            <div className="flex flex-col lg:flex-row items-center gap-12">
              ...
              <div className="flex-1 text-center lg:text-left">
                <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">
                  Welcome to the <span className="text-blue-600">SafED</span> community
                </h1>
                <p className="text-xl text-gray-600 mb-8 max-w-2xl lg:mx-0 mx-auto">
                  The place to get support, ask and answer questions and contribute to the open source learning platform, SafED LMS.
                </p>
                <div className="flex gap-4 justify-center lg:justify-start">
                  <button 
                    onClick={() => { setSelectedCourse(courses[0]); setActiveModal('course'); }}
                    className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition shadow-sm font-medium"
                  >
                    Browse courses
                  </button>
                  <button 
                    onClick={() => setActiveModal('cohorts')}
                    className="bg-white text-blue-600 px-8 py-3 rounded-lg hover:bg-gray-50 transition border border-blue-200 font-medium"
                  >
                    View cohorts
                  </button>
                </div>
              ...
              {/* RIGHT SIDE - YOUR IMAGE (hero-image.jpg) */}
              <div className="flex-1">
                <div className="relative w-full h-[400px] bg-gradient-to-br from-blue-100 to-blue-50 rounded-2xl shadow-lg overflow-hidden border border-blue-200">
                  <Image 
                    src="/hero-image.jpg" 
                    alt="SafED Learning Platform"
                    fill
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="flex flex-wrap gap-3 justify-center">
              {categoryItems.map((item, i) => (
                <button 
                  key={item} 
                  onClick={() => { setSelectedCourse(courses[i]); setActiveModal('course'); }}
                  className="px-4 py-2 bg-gray-100 text-gray-700 rounded-full text-sm hover:bg-blue-100 hover:text-blue-600 transition"
                >
                  {item}
                </button>
              ))}
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="ml-0 lg:ml-16 mb-12">
              <div className="bg-white p-6 rounded-2xl border border-gray-200 inline-block">
                <p className="text-blue-600 font-semibold text-sm mb-2">COURSES</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 ml-0 lg:ml-16">
              {courses.slice(0,4).map(course => (
                <button 
                  key={course.id} 
                  onClick={() => { setSelectedCourse(course); setActiveModal('course'); }}
                  className="bg-white p-6 rounded-lg text-left hover:shadow-md transition border border-gray-200 group"
                >
                  <div className={`w-12 h-12 rounded-full ${course.color} flex items-center justify-center mb-4 shadow-sm group-hover:scale-110 transition`}>
                    <course.icon className="w-6 h-6" />
                  </div>
                  <h3 className="text-gray-900 font-bold mb-1">{course.name}</h3>
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="ml-0 lg:ml-16 mb-12">
              <div className="bg-white p-6 rounded-2xl border border-gray-200 inline-block">
                <p className="text-blue-600 font-semibold text-sm mb-2">PROGRAMS</p>
            ...
            <div className="grid md:grid-cols-2 gap-6 ml-0 lg:ml-16">
              <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm">
                ...
                <h3 className="text-xl font-bold text-gray-900 mb-2">Group Level</h3>
                <p className="text-gray-600">Social Media Branding, Computer Programming, Entrepreneurship, and SRHR with team collaboration</p>
              </div>
              <div className="bg-white p-8 rounded-lg border border-gray-200 shadow-sm">
                <Award className="w-12 h-12 text-blue-600 mb-4" />
                <h3 className="text-xl font-bold text-gray-900 mb-2">Team Level</h3>
                <p className="text-gray-600">Advanced Team Management for organizational leadership</p>
              </div>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-6 max-w-7xl relative z-10">
            <div className="ml-0 lg:ml-16 max-w-2xl">
              <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
                <p className="text-blue-200 font-semibold text-sm mb-2">GET STARTED</p>
                <h2 className="text-3xl font-bold text-white mb-3">Ready to start your journey?</h2>
                <p className="text-lg text-white mb-6 font-medium">Join a cohort and learn alongside motivated peers</p>
                <button 
                  onClick={() => setActiveModal('cohorts')}
                  className="bg-white text-blue-600 px-8 py-4 rounded-lg hover:bg-gray-100 shadow-lg font-medium"
                >
                  Browse Open Cohorts
                </button>
              </div>
            ...
            <div>
              <div className="flex flex-col mb-4">
                <h1 className="text-lg font-bold tracking-tight">
                  <span className="text-blue-500">Saf</span>
