  ...
  return (
    <div className="px-4 md:px-8 py-5 md:py-7 ">
      ...
      <div className="flex gap-2 mb-5 flex-wrap">
        <span className="font-mono text-[11px] px-2.5 py-0.5 rounded-full border border-[#63b3ed]/30 text-[#63b3ed] bg-[#63b3ed]/5">▶ Video</span>
        <span className="font-mono text-[11px] px-2.5 py-0.5 rounded-full border border-[#f6ad55]/30 text-[#f6ad55] bg-[#f6ad55]/5">Week 3</span>
        <span className="font-mono text-[11px] px-2.5 py-0.5 rounded-full border border-white/[0.07] text-gray-400">25 min</span>
        <span className="font-mono text-[11px] px-2.5 py-0.5 rounded-full border border-white/[0.07] text-gray-400">JavaScript</span>
        <span className="font-mono text-[11px] px-2.5 py-0.5 rounded-full border border-white/[0.07] text-gray-400">Async</span>
      </div>
