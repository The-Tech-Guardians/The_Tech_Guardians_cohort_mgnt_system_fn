...
export default function QuizTab() {
  ...
  return (
    <div className="bg-white text-black border border-white/[0.07] rounded-xl overflow-hidden">
      <div className="px-5 py-4 bg-white border-b border-white/[0.07] flex items-center justify-between">
            ...
            {[
              ...
              >
                <div className={`w-[22px] h-[22px] rounded-full border grid place-items-center font-mono text-[10px] font-semibold flex-shrink-0 transition ${
                  selected === i ? 'bg-[#63b3ed] border-[#63b3ed] text-white' : 'bg-gray-200 border-white/[0.07]'
                }`}>
      ...
      <div className="px-5 py-4 border-t border-white/[0.07] bg-white` flex items-center justify-between">
