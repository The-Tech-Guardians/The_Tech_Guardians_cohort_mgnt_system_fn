export default function OverviewTab() {
  return (
    <div>
      <div className=" bg-gray-200 border border-white  rounded-xl p-4 mb-4">
      ...
      <div className="text-sm leading-relaxed text-gray-400 space-y-3">
        <h3 className="font-['Syne'] text-[15px] font-semibold text-gray-900 mt-5 mb-2">Introduction</h3>
        ...
        <h3 className="font-['Syne'] text-[15px] font-semibold text-gray-900 mt-5 mb-2">The Event Loop</h3>
      ...
      <div className="font-['Syne'] text-xs font-bold uppercase tracking-wider text-gray-900 mb-3">Resources</div>
      <div className="grid grid-cols-2 gap-2.5">
        {[
          ...
          <a key={i} href="#" className="flex items-center gap-2.5 p-3  border border-white bg-gray-200 rounded-lg   transition">
            <div className="w-8 h-8 rounded-lg grid place-items-center text-[15px] bg-white " >
              {res.icon}
            </div>
            <div className="flex-1 min-w-0">
              <div className="text-[13px] font-medium text-blue-600 truncate">{res.name}</div>
