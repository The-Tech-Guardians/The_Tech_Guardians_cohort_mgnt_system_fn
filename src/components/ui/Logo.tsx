...
// Footer-inspired Logo — safED with shield & book icon
...
const Logo: FC<LogoProps> = ({ variant = "light", showText = true, className = "" }) => {
  const isDark = variant === "dark";

  return (
    <div
      className={`flex items-center gap-[11px] cursor-pointer flex-shrink-0 group select-none ${className}`}
